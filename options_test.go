...
import (
	...
	"github.com/jamsman94/slicehelper"
)
...
type StructWithInterface struct {
	InnerStruct interface{}
}

var _ = Describe("Replace nil Slice With Empty Slice", func() {
	mystring := "a"
	var nilSlice []string
	...
	DescribeTable("Testing with different structs",
		...
		Entry("struct with interface - nil interface", testCase{
